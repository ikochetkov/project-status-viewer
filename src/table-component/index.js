...
const toggleSort = (tabId, colKey) => {
	...
	console.log('SORT CLICKED', tabId, colKey);
...
const getSortedRows = (rows, tabId) =>
	sortList(rows, getSortState(tabId));
...
<div className="tooltip-wrapper">
							...
							<div>
								...
								<div className="table-wrap">
									...
									<thead>
										<tr>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('milestones','number')}}>
													Number{renderSortIcon('milestones','number')}
												</span>
											</th>
											<th>
												<span	 className="th-sort" on={{click: () => toggleSort('milestones','short_description')}}>
													Short description{renderSortIcon('milestones','short_description')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('milestones','state')}}>
													State{renderSortIcon('milestones','state')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('milestones','due_date')}}>
													Due date{renderSortIcon('milestones','due_date')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('milestones','end_date')}}>
													Planned end{renderSortIcon('milestones','end_date')}
												</span>
											</th>
											<th className="col-progress">
												<span className="th-sort" on={{click: () => toggleSort('milestones','percent_complete')}}>
													Percent Complete{renderSortIcon('milestones','percent_complete')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('milestones','comments')}}>
													Comments{renderSortIcon('milestones','comments')}
												</span>
											</th>
										</tr>
									</thead>
							...
							<div>
								...
								<div className="table-wrap">
									...
									<thead>
										<tr>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('issues','number')}}>
													Number{renderSortIcon('issues','number')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('issues','short_description')}}>
													Short description{renderSortIcon('issues','short_description')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('issues','impact')}}>
													Impact{renderSortIcon('issues','impact')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('issues','priority')}}>
													Priority{renderSortIcon('issues','priority')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('issues','state')}}>
													State{renderSortIcon('issues','state')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('issues','assigned_to')}}>
													Assigned to{renderSortIcon('issues','assigned_to')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('issues','sys_created_on')}}>
													Created{renderSortIcon('issues','sys_created_on')}
												</span>
											</th>
											<th>
												<span className="th-sort" on={{click: () => toggleSort('issues','due_date')}}>
													Due date{renderSortIcon('issues','due_date')}
												</span>
											</th>
										</tr>
									</thead>
	...
	<tr>
		<th>
			<span className="th-sort" on={{click: () => toggleSort('risks','number')}}>
				Number{renderSortIcon('risks','number')}
			</span>
		</th>
		<th>
			<span className="th-sort" on={{click: () => toggleSort('risks','short_description')}}>
				Short description{renderSortIcon('risks','short_description')}
			</span>
		</th>
		<th>
			<span className="th-sort" on={{click: () => toggleSort('risks','u_risk_issue_type')}}>
				Risk type{renderSortIcon('risks','u_risk_issue_type')}
			</span>
		</th>
		<th>
			<span className="th-sort" on={{click: () => toggleSort('risks','impact')}}>
				Impact{renderSortIcon('risks','impact')}
			</span>
		</th>
		<th>
			<span className="th-sort" on={{click: () => toggleSort('risks','mitigation')}}>
				Mitigation plan{renderSortIcon('risks','mitigation')}
			</span>
		</th>
		<th>
			<span className="th-sort" on={{click: () => toggleSort('risks','risk_state')}}>
				Risk state{renderSortIcon('risks','risk_state')}
			</span>
		</th>
		<th>
			<span className="th-sort" on={{click: () => toggleSort('risks','assigned_to')}}>
				Assigned to{renderSortIcon('risks','assigned_to')}
			</span>
		</th>
		<th>
			<span className="th-sort" on={{click: () => toggleSort('risks','sys_created_on')}}>
				Created{renderSortIcon('risks','sys_created_on')}
			</span>
		</th>
		<th>
			<span className="th-sort" on={{click: () => toggleSort('risks','due_date')}}>
				Due date{renderSortIcon('risks','due_date')}
			</span>
		</th>
	</tr>
</thead>
						...
						{project.status_history && project.status_history.length > 0 ? (
							<div className="table-wrap">
								...
								<thead>
									<tr>
										<th>
											<span className="th-sort" on={{click: () => toggleSort('history','number')}}>
												Number{renderSortIcon('history','number')}
											</span>
										</th>
										<th><span className="th-sort" on={{click: () => toggleSort('history','as_on')}}>
												Date{renderSortIcon('history','as_on')}
											</span></th>
								...
								<tbody>
									{(() => { 
										console.log('Project status history data:', project.status_history);
//  const filtered = (project.status_history || [])
    //   .filter(h => !showActiveOnly || isActiveFlag(h.active));

    const rows = getSortedRows(project.status_history, 'history');   //  Step 3 applied
...
// Register component tag used by the example/demo harness
